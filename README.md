...
* **⚙️ Moving Platforms**: Sliding blocks that move across X and Z axes to transport Arre or crush obstacles.
* **☁️ Cloud Blocks**: Floating semi-transparent sky paths.
* **🪙 Golden Coins**: Goal of each level; collecting the 11th coin completes the game and reveals the painted sky ending!
* **⏱️ Speedrun Timer**: Invisible run timer that records your best completion time locally (`ac_best`) and displays it on the start and victory screens.
